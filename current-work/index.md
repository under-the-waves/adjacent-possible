...
const researchData = {
    'research-engagement': {
        title: 'Global Employee Engagement',
        content: 'Gallup\'s 2025 State of the Global Workplace report finds that only 21% of employees worldwide are engaged at work. 45% of workers report that they work primarily for pay, suggesting the majority lack intrinsic motivation or meaning in their roles. <a href="https://www.gallup.com/workplace/349484/state-of-the-global-workplace.aspx" target="_blank">View report</a>'
    },
    ...
    'research-flow': {
        ...
        content: 'McKinsey research found that flow states occupy roughly 5% of the average worker\'s time, yet executives report being up to 500% more productive when in flow. Doubling the time spent in flow can nearly double overall productivity, making flow one of the highest-leverage performance interventions available. <a href="https://www.mckinsey.com/capabilities/people-and-organizational-performance/our-insights" target="_blank">View research</a>'
    },
    ...
    'level2-competence': {
        ...
        content: 'Consistently exceeding expectations places you above roughly 80% of workers. The Dreyfus proficient stage describes someone who sees situations holistically rather than following rules, and whose output requires minimal correction. This level of reliable quality and independent judgement distinguishes strong performers from the majority.'
    },
    'level2-engagement': {
    ...
    'level3-competence': {
        ...
        content: 'The Dreyfus expert stage describes someone whose responses are fluid and intuitive, drawing on extensive pattern recognition. Producing 4x average output and being actively sought for advice represents top 5% competence. At this level, colleagues trust your judgement implicitly and you can handle novel problems without established procedures.'
    },
    'level3-engagement': {
    ...
    'level5-competence': {
        ...
        content: 'Advancing the practice itself \u2013 creating knowledge, methods, or standards that did not previously exist \u2013 represents 99.9th percentile competence (1 in 1,000). This level goes beyond mastering existing practices to generating genuinely new contributions to the field.'
    },
    'level5-engagement': {
