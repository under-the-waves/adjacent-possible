...
<div class="la-banner la-banner--start" id="level1Banner">
    <p><strong>You haven't started the Awareness assessment for Saving yet.</strong><br>It takes about 15 minutes and helps you understand what saving means to you.</p>
    <a href="{{ site.baseurl }}/saving/level-1" class="btn-cta">Begin assessment</a>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (done && hasSliders) {
        ...
        banner.innerHTML = '<p><strong>You have completed Awareness assessment for Saving.</strong></p>' +
            '<a href="{{ site.baseurl }}/saving/personalised" class="btn-cta" style="background:#4CAF50;">View Your Interventions</a>' +
            '<a href="{{ site.baseurl }}/saving/level-1" class="btn-secondary">Redo assessment</a>';
        ...
        banner.innerHTML = '<p><strong>Awareness assessment in progress (' + completed + '/5 steps complete).</strong></p>' +
            '<a href="{{ site.baseurl }}/saving/level-1" class="btn-cta">Continue assessment</a>';
    }
});
</script>
