...
- [Communication]({{ site.baseurl }}/communication) – how effectively you express ideas, listen, and connect with others
- [Friendship]({{ site.baseurl }}/friendship) – your personal relationships, trust, and social support

<div class="la-banner la-banner--start" id="level1Banner">
    <p><strong>You haven't started the Awareness assessment for Networks yet.</strong><br>It takes about 15 minutes and helps you understand what networks mean to you.</p>
    <a href="{{ site.baseurl }}/networks/level-1" class="btn-cta">Begin assessment</a>
</div>
...
<h3>Depth</h3>
<p>The quality and strength of key professional relationships – trusted advisors, mentors, collaborators, and allies who genuinely understand your work and advocate for you.</p>
</div>

<div class="value-card">
<h3>Breadth</h3>
<p>The range and diversity of your professional network – connections across different industries, roles, seniority levels, and backgrounds.</p>
</div>

<div class="value-card">
<h3>Relevance</h3>
<p>Ensuring your network connections are aligned with your current and future professional direction, and regularly evaluating whether they serve your goals.</p>
</div>

<div class="la-paths">
    <a href="{{ site.baseurl }}/networks/level-1" class="path-level1">
        Begin assessment
        <div class="path-desc">Understand networks, set your values, assess where you are</div>
    </a>
    <a href="{{ site.baseurl }}/networks/personalised" class="path-interventions">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var hasSliders = !!sliderWeights['networks'];

    if (done && hasSliders) {
        banner.className = 'la-banner la-banner--complete';
        banner.innerHTML = '<p><strong>You have completed Awareness assessment for Networks.</strong></p>' +
            '<a href="{{ site.baseurl }}/networks/personalised" class="btn-cta" style="background:#4CAF50;">View Your Interventions</a>' +
            '<a href="{{ site.baseurl }}/networks/level-1" class="btn-secondary">Redo assessment</a>';
        ...
        banner.innerHTML = '<p><strong>Awareness assessment in progress (' + completed + '/5 steps complete).</strong></p>' +
            '<a href="{{ site.baseurl }}/networks/level-1" class="btn-cta">Continue assessment</a>';
    }
});
</script>
