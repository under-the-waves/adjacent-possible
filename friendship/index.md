...
- [Relationship quality]({{ site.baseurl }}/relationship-quality/) – how well you connect, collaborate, and grow with an intimate partner
- [Relationship status]({{ site.baseurl }}/relationship-status/) – finding a partner, deciding to stay or leave, and building a fulfilling life single or partnered
...
<div class="la-banner la-banner--start" id="level1Banner">
    <p><strong>You haven't started the Awareness assessment for Friendship yet.</strong><br>It takes about 15 minutes and helps you understand what friendship means to you.</p>
    <a href="{{ site.baseurl }}/friendship/level-1" class="btn-cta">Begin assessment</a>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (done && hasSliders) {
        ...
        banner.innerHTML = '<p><strong>You have completed Awareness assessment for Friendship.</strong></p>' +
            '<a href="{{ site.baseurl }}/friendship/personalised" class="btn-cta" style="background:#4CAF50;">View Your Interventions</a>' +
            '<a href="{{ site.baseurl }}/friendship/level-1" class="btn-secondary">Redo assessment</a>';
        ...
        banner.innerHTML = '<p><strong>Awareness assessment in progress (' + completed + '/5 steps complete).</strong></p>' +
            '<a href="{{ site.baseurl }}/friendship/level-1" class="btn-cta">Continue assessment</a>';
    }
});
</script>
