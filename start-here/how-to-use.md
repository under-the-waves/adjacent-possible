...
## 1. Browse a [life area]({{ site.baseurl }}/life-areas/) (5 minutes)
...
## 2. Take the [prioritisation survey]({{ site.baseurl }}/prioritisation-survey/) (5–30 minutes)
...
For more on why the framework is structured this way, see the [Overview]({{ site.baseurl }}/start-here/overview/). To understand the terms used on Worthwhile, go to [Key Terms]({{ site.baseurl }}/start-here/key-terms/).
