...
**Why it matters**
- Mental health influences virtually every area of life &ndash; decision-making, relationships, physical health, and work performance. People who exercise report <a href="https://jamanetwork.com/journals/jamapsychiatry/article-abstract/2720689" target="_blank">43% fewer days</a> of poor mental health per month, and depression increases <a href="https://www.verywellmind.com/the-mental-and-physical-health-connection-7255857" target="_blank">cardiovascular disease risk by 20 &ndash; 40%</a>. The <a href="https://www.who.int/teams/mental-health-and-substance-use/promotion-prevention/mental-health-in-the-workplace" target="_blank">WHO estimates</a> that 12 billion working days are lost annually to depression and anxiety alone.

**Related life areas**
- [Mindfulness]({{ site.baseurl }}/mindfulness/) &ndash; your capacity for present-moment awareness and non-judgemental attention
...
- [Behaviours]({{ site.baseurl }}/behaviours/) &ndash; your daily habits, routines, and behavioural patterns

<div class="la-banner la-banner--start" id="level1Banner">
    <p><strong>You haven't started the Awareness assessment for Mental Health yet.</strong><br>It takes about 15 minutes and helps you understand what mental health means to you.</p>
    <a href="{{ site.baseurl }}/mental-health/level-1" class="btn-cta">Begin assessment</a>
</div>
...
<div class="la-paths">
    <a href="{{ site.baseurl }}/mental-health/level-1" class="path-level1">
        Begin assessment
        <div class="path-desc">Understand mental health, set your values, assess where you are</div>
    </a>
    <a href="{{ site.baseurl }}/mental-health/personalised" class="path-interventions">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var mentalHealth = progress['mental-health'] || {};
    var steps = ['why', 'values', 'achievable', 'assess'];
    var done = steps.every(function(s) { return mentalHealth[s]; });
    var sliderWeights = APStorage.load('ap-slider-weights') || {};
    var hasSliders = !!sliderWeights['mental-health'];

    if (done && hasSliders) {
        banner.className = 'la-banner la-banner--complete';
        banner.innerHTML = '<p><strong>You have completed Awareness assessment for Mental Health.</strong></p>' +
            '<a href="{{ site.baseurl }}/mental-health/personalised" class="btn-cta" style="background:#4CAF50;">View Your Interventions</a>' +
            '<a href="{{ site.baseurl }}/mental-health/level-1" class="btn-secondary">Redo assessment</a>';
    } else if (Object.keys(mentalHealth).length > 0) {
        var completed = steps.filter(function(s) { return mentalHealth[s]; }).length;
        if (hasSliders) completed++;
        banner.innerHTML = '<p><strong>Awareness assessment in progress (' + completed + '/5 steps complete).</strong></p>' +
            '<a href="{{ site.baseurl }}/mental-health/level-1" class="btn-cta">Continue assessment</a>';
    }
});
</script>
