...
<div class="la-banner la-banner--start" id="level1Banner">
    <p><strong>You haven't started the Awareness assessment for Nutrition yet.</strong><br>It takes about 15 minutes and helps you understand what nutrition means to you.</p>
    <a href="{{ site.baseurl }}/nutrition/level-1" class="btn-cta">Begin assessment</a>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (done && hasSliders) {
        ...
        banner.innerHTML = '<p><strong>Awareness assessment in progress (' + completed + '/5 steps complete).</strong></p>' +
            '<a href="{{ site.baseurl }}/nutrition/level-1" class="btn-cta">Continue assessment</a>';
    }
});
</script>
